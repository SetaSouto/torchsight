...
class DirectionalClassification(nn.Module):
    ...
    def forward(self, feature_map, anchors=None, annotations=None):
        ...
        Arguments:
            feature_map (torch.Tensor): Feature map generated by the FPN module.
                Shape:
        ...
        """
        embeddings = self.encode(feature_map)
...
class DLDENet(RetinaNet):
    ...
    def forward(self, images, annotations=None):
        ...
        classifications = torch.cat([self.classification(feature_map, anchors, annotations)
