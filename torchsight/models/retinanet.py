...
class RetinaNet(nn.Module):
    ...
    def from_checkpoint(cls, checkpoint, device=None):
        """Load a RetinaNet instance from a checkpoint generated by the RetinaNet trainer.

        Arguments:
            checkpoint (str or dict): with the path of the checkpoint or the checkpoint itself.
            device (str, optional): where to load the model if the checkpoint arg is str.

        Returns:
            RetinaNet: with the parameters of the checkpoint.
        """
