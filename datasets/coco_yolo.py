"""Module that contains an old version of the Dataset inspired by the dataset
provided by Joseph Redmon. Please prefere to use coco.CocoDataset dataset instead.
"""
